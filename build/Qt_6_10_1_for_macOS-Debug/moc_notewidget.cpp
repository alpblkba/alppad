...
namespace {
struct qt_meta_tag_ZN10NoteWidgetE_t {};
} // unnamed namespace

template <> constexpr inline auto NoteWidget::qt_create_metaobjectdata<qt_meta_tag_ZN10NoteWidgetE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<NoteWidget, qt_meta_tag_ZN10NoteWidgetE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject NoteWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10NoteWidgetE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10NoteWidgetE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN10NoteWidgetE_t>.metaTypes,
    nullptr
} };
...
void NoteWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (NoteWidget::*)(int )>(_a, &NoteWidget::removeNote, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (NoteWidget::*)(int , const QString & )>(_a, &NoteWidget::renameNote, 1))
            return;
    }
}
...
void *NoteWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10NoteWidgetE_t>.strings))
