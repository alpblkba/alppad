...
template <> constexpr inline auto NoteManager::qt_create_metaobjectdata<qt_meta_tag_ZN11NoteManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'newNoteCreated'
        QtMocHelpers::SignalData<void(int)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 3 },
        }}),
        // Signal 'noteContentChanged'
...
void NoteManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (NoteManager::*)(int )>(_a, &NoteManager::newNoteCreated, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (NoteManager::*)(int )>(_a, &NoteManager::noteContentChanged, 1))
            return;
    }
}
...
// SIGNAL 0
void NoteManager::newNoteCreated(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void NoteManager::noteContentChanged(int _t1)
{
